...
const Third_Page = () => {
  return (
    <div className='h-screen w-screen bg-gray-500 items-center justify-center overflow-hidden'>
        ...
        <div className='translate-x-[1150px] -translate-y-[400px]'>
            <p className='text-black font-bold -translate-y-[400px] underline translate-x-10 text-4xl'>5-20%</p>
            <p className='text-black font-bold -translate-y-[400px] underline translate-x-10 text-4xl'> todayOff</p>
